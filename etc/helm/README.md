...
```
127.0.0.1 foundation-local-web
127.0.0.1 foundation-local-webgateway
127.0.0.1 foundation-local-authserver
```
...
Now, you can browse the URL: `https://foundation-local-web`
