...
using DentistryFoundationSSO.Permissions;
...
namespace DentistryFoundationSSO.Blazor.Client.Navigation;

public class DentistryFoundationSSOMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public DentistryFoundationSSOMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<DentistryFoundationSSOResource>();
        ...
        context.Menu.AddItem(new ApplicationMenuItem(
            DentistryFoundationSSOMenus.Home,
            l["Menu:Home"],
            "/",
            icon: "fas fa-home",
            order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                DentistryFoundationSSOMenus.HostDashboard,
                l["Menu:Dashboard"],
                "/HostDashboard",
                icon: "fa fa-chart-line",
                order: 2
            ).RequirePermissions(DentistryFoundationSSOPermissions.Dashboard.Host)
        );

        //TenantDashboard
        context.Menu.AddItem(
            new ApplicationMenuItem(
                DentistryFoundationSSOMenus.TenantDashboard,
                l["Menu:Dashboard"],
                "/Dashboard",
                icon: "fa fa-chart-line",
                order: 2
            ).RequirePermissions(DentistryFoundationSSOPermissions.Dashboard.Tenant)
        );
        ...
        context.Menu.AddItem(new ApplicationMenuItem(
            DentistryFoundationSSOMenus.FileManager,
            l["FileManager"],
            "/FileManager",
        ...
        //context.Menu.AddItem(new ApplicationMenuItem(
        //    DentistryFoundationSSOMenus.CvatWindow,
        //    l["CvatWindowIframe"],
        //    "/CvatWindowIframe",
