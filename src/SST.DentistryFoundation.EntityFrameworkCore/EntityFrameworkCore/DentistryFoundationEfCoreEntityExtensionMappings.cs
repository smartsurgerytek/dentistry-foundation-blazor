...
public static class DentistryFoundationEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE DentistryFoundationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
