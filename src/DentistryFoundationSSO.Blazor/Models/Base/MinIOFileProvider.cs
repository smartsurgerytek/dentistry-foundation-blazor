...
namespace Syncfusion.EJ2.FileManager.MinIOFileProvider
{
    public class MinIOFileProvider
    {
        ...
        public void RegisterMinIO(string name, string awsAccessKeyId, string awsSecretAccessKey, string region)
        {
            bucketName = name;
