...
public static class DentistryFoundationSSOEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE DentistryFoundationSSOModuleExtensionConfigurator CLASS (in the Domain.Shared project)
