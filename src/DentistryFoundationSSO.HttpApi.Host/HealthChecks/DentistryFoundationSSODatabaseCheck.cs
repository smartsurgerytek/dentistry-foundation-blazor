...
public class DentistryFoundationSSODatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public DentistryFoundationSSODatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
