...
namespace DentistryFoundationSSO.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("DentistryFoundationSSO") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "DentistryFoundationSSO", DisplayName = "DentistryFoundationSSO API", Resources = { "DentistryFoundationSSO" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["DentistryFoundationSSO_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["DentistryFoundationSSO_App:RootUrl"]?.TrimEnd('/');
        ...
        // Blazor Client
        var blazorClientId = configurationSection["DentistryFoundationSSO_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["DentistryFoundationSSO_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["DentistryFoundationSSO_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["DentistryFoundationSSO_Swagger:RootUrl"]?.TrimEnd('/');
