...
namespace Syncfusion.EJ2.FileManager.FileProvider
{
    public class FileProvider
    {
        ...
        public void RegisterAmazonS3OrMinioFileProvider(string name, string rootFolder)
        {
            bucketName = name;
            CreateBucket(bucketName).Wait();

            rootFolder = string.IsNullOrEmpty(rootFolder) ? "foundation/" : rootFolder;
        ...
        public void GetBucketList()
        {
            ...
            RootName = allObjects == null || allObjects.Count() == 0 ? RootName : allObjects.First().Key;
